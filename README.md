...
- [`site/`](site/) — the website: a static dev blog (posts, quotes, about) in
  HTML and CSS only. Its quotes section is a flat front door onto the research
  bundle below — one card per quote, the levels left behind. Open
  `site/index.html`, or see [`site/README.md`](site/README.md).
