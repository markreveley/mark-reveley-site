...
deps:
  - { concept: /excerpts/okf-formalizes-the-llm-wiki-pattern.md, rel: refines }
...
- **refines** → [OKF formalizes the LLM-wiki pattern](../excerpts/okf-formalizes-the-llm-wiki-pattern.md)
