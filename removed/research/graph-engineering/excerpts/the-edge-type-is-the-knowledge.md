...
deps:
  - { concept: /excerpts/an-untyped-edge-is-one-bit.md, rel: supports }
...
Curl-verified; ellipsis spans verified fragments. The maximal typed-edge position; the per-hop argument objects to it.

# Relations

- **supports** → [An untyped edge is one bit](../excerpts/an-untyped-edge-is-one-bit.md)
