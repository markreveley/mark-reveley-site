...
deps:
  - { concept: /excerpts/the-edge-type-is-the-knowledge.md, rel: objects-to }
...
Curl-verified. The same arithmetic appears independently in Flowtivity; it tempers maximal traversal claims, and the routing position answers it.

# Relations

- **objects-to** → [The edge type IS the knowledge](../excerpts/the-edge-type-is-the-knowledge.md)
