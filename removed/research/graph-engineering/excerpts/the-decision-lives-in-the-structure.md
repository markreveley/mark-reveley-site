...
deps:
  - { concept: /excerpts/yes-and-no-storage-shapes-retrieval.md, rel: supports }
  - { concept: /excerpts/decision-trees-dont-fit-csv-rows.md, rel: supports }
...
- **supports** → [Yes and no: storage shapes retrieval](../excerpts/yes-and-no-storage-shapes-retrieval.md)
- **supports** → [Decision trees don't fit CSV rows](../excerpts/decision-trees-dont-fit-csv-rows.md)
