...
deps:
  - { concept: /excerpts/act-observe-decide-repeat.md, rel: refines }
...
Curl-verified. The halting hazard; the commitments position moves “done” from prompt aspiration to a predicate over schema'd state.

# Relations

- **refines** → [Act, observe, decide, repeat](../excerpts/act-observe-decide-repeat.md)
