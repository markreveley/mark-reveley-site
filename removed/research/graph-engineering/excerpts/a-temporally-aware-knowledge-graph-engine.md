...
deps:
  - { concept: /excerpts/a-buffer-and-a-static-knowledge-base.md, rel: answers }
...
- **answers** → [A buffer and a static knowledge base](../excerpts/a-buffer-and-a-static-knowledge-base.md)
