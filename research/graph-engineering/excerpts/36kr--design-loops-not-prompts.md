...
> "Monthly reminder: you should no longer prompt programming agents yourself. You should design loops that prompt agents." [^kr]

**[claim]** — Addy Osmani's definitional gloss (same article):
