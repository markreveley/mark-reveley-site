...
deps:
  - { concept: /excerpts/workflows-vs-agents.md, rel: precedes }
...
Curl-verified against Wikipedia. The 2011 standard for executable process graphs — including human tasks: interpretive nodes at human cost, before model nodes.

# Relations

- **precedes** → [Workflows vs agents](../excerpts/workflows-vs-agents.md)
