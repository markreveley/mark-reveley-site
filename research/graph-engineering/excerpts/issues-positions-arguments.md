...
deps:
  - { concept: /excerpts/making-links-so-a-person-or-machine-can-explore.md, rel: precedes }
...
Curl-verified against Wikipedia. Typed argumentation graphs with attachment rules (1970; gIBIS 1988). Reflexive note: this bundle's v3 schema is an extended IBIS — adopted knowingly on 2026-08-25.

# Relations

- **precedes** → [Making links, so a person or machine can explore](../excerpts/making-links-so-a-person-or-machine-can-explore.md)
