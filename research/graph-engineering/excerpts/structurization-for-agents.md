...
deps:
  - { concept: /excerpts/legible-to-humans-and-machines.md, rel: supports }
...
Curl-verified against the arXiv abstract. Academic ratification predating the naming event by a year; subsumes the retrieval, memory, and coordination strands under structurization.

# Relations

- **supports** → [Legible to humans and machines](../excerpts/legible-to-humans-and-machines.md)
