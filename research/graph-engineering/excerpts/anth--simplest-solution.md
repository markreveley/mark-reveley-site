...
Curl-verified. The standing restraint position; the exit-report argument supports it from practice, and the autonomy-tradeoff position prices it.

# Relations

- **responds-to** → [How much structure?](../issues/how-much-structure.md)
- **supports** → [Organized nonsense at industrial scale](../excerpts/lb--organized-nonsense.md)
