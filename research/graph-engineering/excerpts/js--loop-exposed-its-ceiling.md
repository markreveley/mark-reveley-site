...
- **refines** → [Throw the DAG away (and what happened next)](../excerpts/12fa--throw-the-dag-away.md)
- **refines** → [Design loops that prompt agents](../excerpts/36kr--design-loops-not-prompts.md)
