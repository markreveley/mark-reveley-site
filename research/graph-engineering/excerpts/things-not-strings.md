...
deps:
  - { concept: /excerpts/making-links-so-a-person-or-machine-can-explore.md, rel: refines }
...
- **refines** → [Making links, so a person or machine can explore](../excerpts/making-links-so-a-person-or-machine-can-explore.md)
