...
deps:
  - { concept: /excerpts/a-graph-is-two-things-nodes-and-edges.md, rel: refines }
...
- **refines** → [A graph is two things: nodes and edges](../excerpts/a-graph-is-two-things-nodes-and-edges.md)
