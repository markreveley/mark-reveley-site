...
deps:
  - { concept: /excerpts/things-not-strings.md, rel: supports }
...
The field guide's knowledge-cast minimal definition; curl-verified. Contrast the capability-cast commitments node, which answers the same "what is graph engineering?" question in orchestration terms.

# Relations

- **supports** → [Things, not strings](../excerpts/things-not-strings.md)
