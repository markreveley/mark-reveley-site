...
deps:
  - { concept: /excerpts/boring-nodes-typed-edges-checkpointed-state.md, rel: supports }
...
Curl-verified. The both-senses definition — knowledge-flavored nodes, orchestration-flavored traversal; [Three memories, one context graph](../excerpts/three-memories-one-context-graph.md) is what that equivocation opens onto — a single graph doing both jobs at once.

# Relations

- **supports** → [Boring nodes, typed edges, checkpointed state](../excerpts/boring-nodes-typed-edges-checkpointed-state.md)
