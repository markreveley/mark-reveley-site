...
Curl-verified. The maximal-control definitional position; same map figure as the seed thread with the direction of authority reversed.

# Relations

- **responds-to** → [What is “graph engineering”?](../issues/what-is-graph-engineering.md)
- **refines** → [A map of how something works](../excerpts/rl--map-metaphor.md)
