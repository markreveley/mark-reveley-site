...
deps:
  - { concept: /excerpts/deciders-workers-durable-state-2012.md, rel: refines }
...
- **refines** → [Deciders, workers, durable state — 2012](../excerpts/deciders-workers-durable-state-2012.md)
