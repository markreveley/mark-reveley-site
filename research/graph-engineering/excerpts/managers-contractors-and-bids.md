...
deps:
  - { concept: /excerpts/the-constraint-moved-to-coordination.md, rel: precedes }
...
- **precedes** → [The constraint moved to coordination](../excerpts/the-constraint-moved-to-coordination.md)
