...
deps:
  - { concept: /excerpts/find-the-simplest-solution-possible.md, rel: refines }
...
- **refines** → [Find the simplest solution possible](../excerpts/find-the-simplest-solution-possible.md)
