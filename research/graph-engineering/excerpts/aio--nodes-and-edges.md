...
The field guide's knowledge-cast minimal definition; curl-verified. Contrast the capability-cast commitments node on the same issue.

# Relations

- **responds-to** → [What is “graph engineering”?](../issues/what-is-graph-engineering.md)
- **supports** → [Things, not strings](../excerpts/gkg--things-not-strings.md)
