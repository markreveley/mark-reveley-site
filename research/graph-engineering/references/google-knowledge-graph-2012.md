...
The industrial coming-out of the knowledge graph: search moves from string matching to an entity-relationship model. Between the semantic-web era and the agentic era, this is the hinge — the moment graph-shaped knowledge became consumer infrastructure.
